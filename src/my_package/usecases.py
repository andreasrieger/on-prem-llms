...
import pandas as pd
import numpy as np
from my_package import userinput, filemanager, ospath, chunking, embedding, storage
...
def main():
    ...
    selected_usecase = userinput.get_user_input("Select use case by number", default="2")
